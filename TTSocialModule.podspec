#
#  Be sure to run `pod spec lint TTSocialModule.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TTSocialModule"
  spec.version      = "0.5"
  spec.summary      = "简单封装第三方平台的分享功能"
  ...
  封装「微信」「微博」等第三方平台SDK，目前支持分享功能。
                   DESC

  spec.homepage     = "https://github.com/keleyundou/TTSocialModule"
  ...
  spec.author             = "ColaBean"
  # Or just: spec.author    = "ColaBean"
  # spec.authors            = { "ColaBean" => "1695390892@qq.com" }
  # spec.social_media_url   = "https://twitter.com/ColaBean"
